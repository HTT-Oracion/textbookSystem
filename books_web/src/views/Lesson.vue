    ...
    <el-card>
      ...
      <el-table :data="lessonList" border stripe v-loading="loading">
        ...
        <el-table-column label="操作" width="150">
          <template #default="scoped">
            <el-button type="primary" size="small" @click="toEdit(scoped.row)"
              >编辑</el-button
            >
            ...
            <el-button
              type="success"
              size="small"
              @click="charge(scoped.row.id, user.id, scoped.row)"
              >订购</el-button
            >
            <!-- :disabled="btnVisible || scoped.row.chargeId !== null" -->
            <!-- <el-button
    ...
    <el-dialog title="添加" :visible.sync="addLesson" width="50%">
      ...
      >
        ...
        <el-form-item label="开课时间" prop="started">
          <el-input
            v-model="addForm.started"
            placeholder="格式为 2020/02/02"
          ></el-input>
        </el-form-item>
