    ...
    <div class="register-box">
      ...
      >
        ...
        <el-form-item
          ...
          v-if="$store.state.userRegister"
        >
          <el-radio v-model="registerForm.level" :label="1" :disabled="disabled"
            >教材管理员</el-radio
          >
          <el-radio v-model="registerForm.level" :label="2" :disabled="disabled"
            >订购员</el-radio
          >
          <el-radio v-model="registerForm.level" :label="3" :disabled="disabled"
            >审核员</el-radio
          >
...
export default {
  ...
  created () {
    if (this.$store.state.userRegister) {
